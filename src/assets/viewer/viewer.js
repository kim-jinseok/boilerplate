...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function webViewerDownload() {
                ...
                var file_history_id = parent.renderFileList.targetRowMain.data("file_history_id");
                location.href = "/webhandler/DownloadHandler.ashx?file_history_id=" + file_history_id+"&user_id="+parent.user.user_id+"&isPdfDownload=1&type=download";
            }
                ...
                _createClass(BaseViewer, [{
                    ...
                    value: function _setScale(value) {
                        ...
                        if (scale > 0) {
                            ...
                            var pageWidthScale = (this.container.clientWidth - hPadding) / currentPage.width * currentPage.scale + 0.025; //여기변경
            ...
            var PDFPageView = function () {
                ...
                _createClass(PDFPageView, [{
                    ...
                    value: function reset() {
                        ...
                        var div = this.div;
                        div.style.width = Math.floor(this.viewport.width) + 'px'; //여기변경
                        div.style.height = Math.floor(this.viewport.height) + 'px';
